...
function toggleLoading(isLoading) {
  ...
  if(isLoading == true){
    ...
    document.getElementById("icon").className="fas fa-hourglass-half"
    document.getElementById("btnText").innerText="Loading...";
    
    const fieldSet = document.getElementById('searchBtn');
